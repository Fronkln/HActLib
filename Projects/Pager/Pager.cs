...
namespace Pager
{
    public partial class Pager : Form
    {
        ...
        private void openButton_Click(object sender, EventArgs e)
        {
            ...
            DEHActPath = ofd.FileName;
            DEHact = CMN.Read(DEHActPath, Game.YLAD);
        ...
        public void ProcessHierarchy()
        {
            ...
            foreach (AuthPage page in DEHact.AuthPages)
            {
                ...
                if (e.KeyCode == Keys.V)
                {
                    ...
                    switch (CopiedNode.GetType().Name)
                    {
                        case "TreeViewItemPage":
                            List<AuthPage> pagesList = DEHact.AuthPages.ToList();
        ...
        private int SwapPages(AuthPage replacer, AuthPage replacing)
        {
            ...
            DEHact.AuthPages[replacerIdx] = replacing;
