...
namespace HActLib
{
    ...
    public enum IshinNodeIDs : uint
    {
        ...
        e_auth_element_body_flash_v2 = 102,
        e_auth_element_subtractive_point_light = 107,
        e_auth_element_stage_parallel_light_animation = 108,
        e_auth_element_character_parallel_light_source_offset = 109,
        e_auth_element_character_light_source = 110,
        e_auth_element_depth_of_field2 = 111,
        e_auth_element_sss_range = 116,
        e_auth_element_adjust_sss_shadow_side_appearance = 117,
        e_auth_element_color_correction_offset = 120,
        e_auth_element_cut_wound = 121,
    }
}
